      ...
      >
        ...
        <div className={cn(
          ...
          {isOpen ? (
            ...
            <>
              <img src={sofiaAvatar} alt="Emily" className="h-8 w-8 rounded-full object-cover" />
        ...
        <div className="fixed bottom-24 right-6 z-50 w-[360px] max-w-[calc(100vw-3rem)] rounded-2xl border border-border bg-background shadow-2xl flex flex-col overflow-hidden animate-in slide-in-from-bottom-5 duration-300">
          ...
          <div className="bg-primary px-4 py-3 flex items-center gap-3">
            <div className="relative">
              <img src={sofiaAvatar} alt="Emily" className="w-10 h-10 rounded-full object-cover border-2 border-primary-foreground/30" />
          ...
          <ScrollArea className="flex-1 h-[320px] p-4">
            {messages.length === 0 && (
              <div className="text-center py-6">
                <img src={sofiaAvatar} alt="Emily" className="w-14 h-14 mx-auto mb-3 rounded-full object-cover border-2 border-primary/30" />
            ...
            <div className="space-y-4">
              {messages.map((msg, i) => {
                ...
                return (
                  ...
                  >
                  {msg.role === 'assistant' && (
                      <img src={sofiaAvatar} alt="Emily" className="w-7 h-7 rounded-full object-cover flex-shrink-0 mt-1" />
                    )}
                    <div className="max-w-[80%] space-y-2">
                      ...
                      {parsed.cadastroInfo && (
                        <AccessDataCard 
                          email={parsed.cadastroInfo.email} 
              ...
              {isLoading && messages[messages.length - 1]?.role !== 'assistant' && (
                <div className="flex gap-2 justify-start">
                  <img src={sofiaAvatar} alt="Emily" className="w-7 h-7 rounded-full object-cover flex-shrink-0" />
